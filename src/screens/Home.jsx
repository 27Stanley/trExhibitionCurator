...
export default function Home() {
  return (
    <div>
      ...
      <section className="text-center rounded-lg bg-slate-100 shadow-md p-8 mb-8">
        <img
        ...
        <button className="mt-4 px-6 py-2 bg-blue-500 text-slate-100 rounded-lg hover:bg-blue-600">
          Start Exploring
        </button>
      </section>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="rounded-lg bg-slate-100 shadow-md p-6">
          <img
      ...
      <section className="text-center rounded-lg bg-slate-100 shadow-md p-8 mt-8">
